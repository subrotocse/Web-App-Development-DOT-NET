...
namespace MigrationAdvanced.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,ProductName,Quantity,Price,ProductTypeId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,ProductName,Quantity,Price,ProductTypeId")] Product product)
        {
            if (ModelState.IsValid)
            {
